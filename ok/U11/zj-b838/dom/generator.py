...
for i in range(secret_count):
    ...
    a = generate_random_one(10,30) # 1~10的亂數
    
    for j in range(a):
        ans = []
        a = str(random.randrange(1000,9999))
        b = str(random.randrange(100000,1000000))
        c = str(random.randrange(10000,100000))
        d = random.randrange(0,4)
        e = str(random.randrange(10000000,100000000))
        lst = [a,b,c,e]
        for x in lst[d]:
            if int(x) % 2 == 0 :
                ans.append('(')

...
\usepackage{listings}
\lstset{basicstyle=\ttfamily, breaklines=true, frame=single, showlines=true}
...
\begin{CJK*}{UTF8}{bkai}
  ...
  \includes{zj-d267/problem.tex}

\end{CJK*}

\end{document}\documentclass[fleqn, 12pt, a4paper]{article}
\usepackage{cmap}
\pdfminorversion=6
\usepackage{CJK}
